...
__attribute__((used, noinline)) void poll_audio_command(audio_command_t *out_command)
{
  ...
  // otherwise the compiler will strip out the call
  // to poll_audio_command in flush_audio_commands
